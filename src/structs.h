...
#define QUANTUMS_IN_MINUTE QUANTUMS_PER_SEC*60
#define QUANTUMS_IN_DAY QUANTUMS_IN_MINUTE*60*24
#define LOGIN_NODE_INTERVAL 5
#define QUANTUMS_IN_FRAME QUANTUMS_IN_MINUTE*5 // Frames will have 5 minute duration
...
#define DISPLAY_COST_LENGTH         6

enum JOBSTATE { JOB_OK, JOB_DONE, JOB_ABORT };
enum LOGTYPE { NODE_FOUND, NODE_ON, NODE_OFF, JOB_ENTER, JOB_START, JOB_FINISH, JOB_ABORTED, SYS_USE, SHUTDOWN, DISPLAY_DATE, DISPLAY_COST, QUEUE_STATUS, QUEUE_ROW, QUEUE_END, QUEUE_ETC };
